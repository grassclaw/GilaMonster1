...
TweenMax.to("#sprite-1", 4, {x:($("#sprite-2").position().left ) });

$(window).resize(function(){
  TweenMax.to("#sprite-1", .5, {x:($("#sprite-2").position().left ) });
});
TweenMax.to("#sprite-3", 4 , {x:($("#sprite-1").position().left ) - $("#sprite-1").width() });
